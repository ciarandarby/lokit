...
def test_html_nested_inline_tags_have_unique_ordered_codes(tmp_path: Path) -> None:
    ...
    assert unit.source == "A {LOKIT_P1}bold {LOKIT_P2}nested{LOKIT_P3} value{LOKIT_P4} tail."
    ...
    assert unprojected.source == "A bold nested value tail."
...
""",
    ...
    assert data.source == "A {LOKIT_P1}bold {LOKIT_P2}nested{LOKIT_P3}{LOKIT_P4} value."
