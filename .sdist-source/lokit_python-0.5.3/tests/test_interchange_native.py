...
def test_native_tmx_complex_units_ignore_the_removed_disable_switch(
    ...
    assert document.data["u0"].source == "Hello {LOKIT_P1}0{LOKIT_P2}"
    assert document.data["u0"].target == "Bonjour {LOKIT_P1}0{LOKIT_P2}"
...
""",
    ...
    assert document.data["u1"].source == "Hello {LOKIT_P1}world{LOKIT_P2}."
    assert document.data["u1"].target == "Bonjour {LOKIT_P1}monde{LOKIT_P2}."
...
""",
    ...
    assert document.data["u1:s1"].source == "Hello {LOKIT_P1}world{LOKIT_P2}."
    assert document.data["u1:s1"].target == "Bonjour {LOKIT_P1}monde{LOKIT_P2}."
